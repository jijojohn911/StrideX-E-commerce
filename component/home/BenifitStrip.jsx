      ...
      <div className="container-stridex">
        ...
        <div className="overflow-hidden rounded-2xl border border-[var(--color-stone-light)]">
          <div className="grid grid-cols-2 lg:grid-cols-4">
            {/* Premium Materials */}
            <div className="flex items-center gap-4 border-b border-r border-[var(--color-stone-light)] px-5 py-7 lg:border-b-0 lg:px-8">
              <Leaf
                size={24}
                strokeWidth={1.5}
            ...
            {/* Free Shipping */}
            <div className="flex items-center gap-4 border-b border-[var(--color-stone-light)] px-5 py-7 lg:border-b-0 lg:border-r lg:px-8">
              <Truck
                size={24}
                strokeWidth={1.5}
                className="shrink-0 text-[var(--color-ink)]"
            ...
            {/* Easy Returns */}
            <div className="flex items-center gap-4 border-r border-[var(--color-stone-light)] px-5 py-7 lg:border-r lg:px-8">
              <RefreshCw
                size={24}
                strokeWidth={1.5}
                className="shrink-0 text-[var(--color-ink)]"
